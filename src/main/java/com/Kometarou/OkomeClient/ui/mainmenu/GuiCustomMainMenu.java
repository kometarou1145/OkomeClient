package com.Kometarou.OkomeClient.ui.mainmenu;
...
import com.Kometarou.OkomeClient.manager.MainMenuManager;
import com.Kometarou.OkomeClient.okome;
import com.Kometarou.OkomeClient.ui.font.CFontRenderer;
...
public class GuiCustomMainMenu extends GuiScreen {
    ...
    private void drawGUI(float mouseX, float mouseY, float rw, float rh,
        ...
        drawString(FontManager.helvetica1, "OKOME", -25.0f, 5.0f, ColorUtil.toRGBA(200, 200, 200), rw, rh);
        drawString(FontManager.helvetica3, "v " + okome.MOD_VERSION, 79f, 23.0f, ColorUtil.toRGBA(50, 50, 50), rw, rh);
