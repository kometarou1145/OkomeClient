package com.Kometarou.OkomeClient.ui.clickgui.component;

import com.Kometarou.OkomeClient.ui.clickgui.Component;
...
public class ModuleButton extends com.Kometarou.OkomeClient.ui.clickgui.Component {
    private final Module module;
    private final List<com.Kometarou.OkomeClient.ui.clickgui.Component> settings = new ArrayList<>();
    ...
    public float render(int x, int y, int mouseX, int mouseY) {
        ...
        if (open) {
            for (com.Kometarou.OkomeClient.ui.clickgui.Component comp : settings) {
