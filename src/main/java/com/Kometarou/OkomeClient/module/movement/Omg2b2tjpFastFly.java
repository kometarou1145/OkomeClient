...
public class Omg2b2tjpFastFly extends Module {
    public Setting<Float> speed = register(new Setting("Speed", 10.0f, 10.0f, 10.0f));
    ...
    public Setting<Integer> factor = register(new Setting("Factor", 30, 30, 30));
    ...
    public Omg2b2tjpFastFly() {
        super("Omg2b2tjpFastFly", Category.MOVEMENT);
    }
    ...
    public void onPlayerUpdate(UpdatePlayerEvent event) {
        ...
        mc.player.connection.sendPacket(new CPacketPlayer.Position(tx, -99999, tz, false));
    }
}
