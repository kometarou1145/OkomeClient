...
public class TestReverseStep extends Module {
    public Setting<String> mode = register(new Setting("Mode", "Reverse", new String[]{"Vanilla", "Reverse"}));
    public Setting<Float> height = register(new Setting("Heigth", 1.0F, 5.0F, 0.1F));

    public TestReverseStep() {
        super("TestReverseStep", Category.MOVEMENT);
    }
