...
import com.Kometarou.OkomeClient.util.player.CrystalUtil;
...
public class FacePlace extends Module {
    ...
    public Setting<Float> placeDelay = register(new Setting("Place Delay", 100.0f, 100.0f, 0.0f));
    ...
    public Setting<Float> placeMinDamage = register(new Setting("Place Min Damage", 1.0f, 20.0f, 0.1f));
    ...
    public Setting<Boolean> silentSwitch = register(new Setting("Silent Switch", true));
    public Setting<String> placeSortMode = register(new Setting("Place Sort Mode", "Nearest", new String[]{"Nearest", "Safest"}));
    ...
    public Setting<Float> explodeDelay = register(new Setting("Explode Delay", 100.0f, 100.0f, 0.0f));
    ...
    public Setting<String> swingArm = register(new Setting("Swing Arm", "Off Hand", new String[]{"Main Hand", "Off Hand", "None"}));
    ...
    public FacePlace() {
        super("FacePlace", Category.COMBAT);
    }
