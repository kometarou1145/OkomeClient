...
import com.Kometarou.OkomeClient.module.movement.Flight;
import com.Kometarou.OkomeClient.module.movement.Scaffold;
import com.google.common.base.Predicate;
import com.google.common.base.Predicates;
import com.Kometarou.OkomeClient.event.player.UpdateLivingPlayerEvent;
...
import com.Kometarou.OkomeClient.util.client.MathUtil;
...
public class MiddleClickFlyFag extends Module {
    public static MiddleClickFlyFag INSTANCE;
    public Setting<Float> distance = register(new Setting("Distance", 5.0f, 5.0f, 5.0f));
    ...
    public Setting<Boolean> scaffold = register(new Setting("Fly", true));
    ...
    public MiddleClickFlyFag() {
        super("MiddleClickFlyFag", Category.COMBAT);
        INSTANCE = this;
    }
    ...
    public void onPlayerUpdate(UpdateLivingPlayerEvent event) {
        ...
        Flight module = (Flight) ModuleManager.INSTANCE.getModuleByClass(Flight.class);
        if (!module.isToggled()) new Flight();module.toggle();
