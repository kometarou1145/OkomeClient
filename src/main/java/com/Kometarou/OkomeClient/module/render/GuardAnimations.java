...
public class GuardAnimations extends Module {
    public static GuardAnimations INSTANCE;
    ...
    public GuardAnimations() {
        super("GuardAnimations", Category.RENDER);
        INSTANCE = this;
    }
    ...
    public void onTick() {
        ...
        isPressed = mc.gameSettings.keyBindUseItem.pressed || mc.player.isSwingInProgress;
    }
}
