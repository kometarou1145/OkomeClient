...
public class FakePlayer2 extends Module {
    private final String name = "kometarou_";
    private final String uuid = "6d1447a0-814d-46f1-838d-50c3ebf9315f";
    public Setting<Boolean> copyInv = register(new Setting("CopyInv", true));
    private EntityOtherPlayerMP fakePlayer;

    public FakePlayer2() {
        super("FakePlayer2", Category.MISC);
    }
    ...
    public static String getUuid(String name) {
        ...
        try {
            ...
            return FakePlayer2.reformatUuid(UUIDObject.get("id").toString());
        } catch (Exception e) {
            e.printStackTrace();
            return "error";
        }
